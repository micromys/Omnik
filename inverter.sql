...
CREATE TABLE `solar_daily_direct` (
  ...
  `fac1` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'Frequency',
  `fac2` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'Frequency',
  `fac3` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'Frequency',
