...
PERFORMANCE ISSUE
-----------------
Whenever you read from the wifi module you might run into timeouts conditions when also data is sent to the portal website, especially when the portal is performing poor causing long response times.
